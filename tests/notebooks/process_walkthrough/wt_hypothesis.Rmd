...
## Identify unique hypothesis number/labels
```{r}
...
h_match_num_unq
```
### Determine Delta between hypothesis numbers
Drop is delta is greater than 3
```{r}
# h_match_num_unq
# 
# h_match_num_unq_sort <- sort(as.numeric(h_match_num_unq))
# 
# h_match_num_unq_sort
# 
# h_num_diff <- diff(as.numeric(h_match_num_unq_sort))
# 
# h_num_diff
# 
# # Add value to first instance
# h_num_diff <- c(0, h_num_diff)
# h_num_diff
# 
# h_num_cutoff <- 3
# 
# log_h_num_diff <- h_num_diff < h_num_cutoff
# 
# log_h_num_diff
# 
# h_match_num_unq_sort_drop <- h_match_num_unq_sort[log_h_num_diff]
```
